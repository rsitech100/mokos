      ...
      return (
            <div className="flex flex-col">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3.5 p-4">
                        ...
                        <div className="border border-neutral-400 bg-neutral-100 flex items-center justify-center gap-1.5 py-2 px-14 rounded-2xl w-full md:w-fit">
                  ...
                  <div className="inline-flex items-center p-4 gap-1.5">
                        ...
                        <p className="text-xs sm:text-sm text-neutral-700 font-semibold">Lokasi Toko: <span className="font-normal">Jakarta Barat</span></p>
                  </div>
                  <hr className="border-neutral-400 w-full " />
            </div>
      )
