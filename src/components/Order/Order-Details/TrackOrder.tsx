...
const StatusDelivery = ({ order, stepIndex, currentStep }: OrderInvoiceProps) => {
      ...
      return (
            <div className="inline-flex gap-3 items-start justify-start">
      ...
      return (
            <div className="flex flex-col bg-white p-5 gap-5 rounded-xl shadow-md">
                  ...
                  <div className="flex flex-col gap-5 relative">
                        <hr className="absolute border-dashed border-neutral-400 w-[275px] rotate-90 top-[150px] right-[220px]"></hr>
