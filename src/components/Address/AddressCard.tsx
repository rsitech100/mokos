...
export function AddressCard({ label, name, telephone, address }: AddressCardProps) {
      ...
      return (
            <div className="flex flex-col md:flex-row justify-between bg-transparent border border-neutral-400 gap-2 p-5 rounded-[12px]">
                  ...
                  <div className="flex justify-center items-center">
                        <div className="w-full md:w-fit px-10 py-2 bg-transparent border border-neutral-400 rounded-3xl font-semibold text-sm cursor-pointer text-center">Pilih</div>
                  </div>
            </div>
      )
}